...
export default async function BlogPage({ searchParams }: BlogPageProps) {
    ...
    // Fetch categories to find the ID if filtering
    ...
    const { posts, totalPages } = await getBlogPosts(page, 9, categoryId);

    // Fetch recent posts for sidebar
    const recentPosts = await getLatestPosts(5);

    // Separate featured post (first post on first page)
