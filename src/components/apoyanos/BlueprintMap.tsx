      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
            Explora el Centro Día
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Haz clic en cada zona para ver las necesidades específicas y cómo puedes ayudar
          </p>
        ...
        <div className="relative bg-white rounded-3xl shadow-xl shadow-gray-200 p-8 md:p-12 border-2 border-primary/10">
          <div 
            ...
            style={{ 
              backgroundImage: 'linear-gradient(#0c2070 1px, transparent 1px), linear-gradient(90deg, #0c2070 1px, transparent 1px)', 
          ...
          <div className="relative z-10">
            <div className="border-4 border-primary/30 rounded-2xl p-6 md:p-8 bg-primary/5">
              <h3 className="text-center text-primary font-bold text-lg mb-6 uppercase tracking-widest">
                Plano del Centro Día - Adultos
              </h3>
                ...
                {zones.map((zone, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="group bg-white border-2 border-gray-200 rounded-xl p-4 text-left hover:border-accent hover:shadow-lg transition-all duration-300"
                    >
                      ...
                      <div className="flex justify-between text-xs text-gray-500">
                        ...
                        <span className="flex items-center gap-1 group-hover:text-accent">
                          Ver más <FaChevronRight className="text-xs" />
                        </span>
                      </div>
                    </motion.button>
                  );
