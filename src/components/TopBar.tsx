...
export default function TopBar() {
    return (
        <div className="bg-[#1b2b65] text-white text-xs md:text-sm py-2">
            <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between">
                <div className="flex items-center gap-6 mb-2 md:mb-0">
                    <div className="flex items-center gap-2">
                        ...
                        <span>Calle 127 B No. 45-28 – Barrio Prado</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="mailto:asistentenorte@aconino.org" className="hover:text-gray-300">
                ...
                <div className="flex items-center gap-4 border-l border-white/20 pl-4">
                    ...
                    <button className="hover:text-gray-300 ml-2">
                        <FaSearch />
                    </button>
                </div>
            </div>
