                        ...
                        {displayPrograms.map((prog, idx) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                                    <Link href="/programas" className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 group-hover:bg-secondary group-hover:text-white transition-all duration-300">
                                        <FaArrowRight />
                                    </Link>
                                </div>
                            </motion.div>
