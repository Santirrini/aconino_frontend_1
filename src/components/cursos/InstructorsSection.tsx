...
export default function InstructorsSection({ groups = defaultGroups }: InstructorsSectionProps) {
    return (
                ...
                <ScrollReveal animation="fade-up" delay={0.1}>
                    <div className="text-center mb-14">
                        ...
                        <p className="text-gray-500 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
                            ...
                            sino también la voluntad de hacernos partícipes de su sensibilidad frente al servicio por
